function App() {
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      >
        <div className="text-center max-w-4xl">
          ...
          <h1 className="text-5xl md:text-7xl font-bold leading-tight">
            Olá, Eu sou
            <span className="text-blue-500"> Silva Maxaxe!</span>
          </h1>
          ...
          <div className="mt-8 flex flex-col sm:flex-row justify-center gap-4">
            ...
            <a
              href="#contacto"
              className="rounded-lg bg-blue-600 px-8 py-4 font-semibold hover:bg-blue-500"
            >
              Entrar em contacto
            </a>
            ...
            <a
              href="#sobre"
              className="rounded-lg border border-gray-700 px-8 py-4 font-semibold hover:bg-gray-800"
            >
              Saber mais
            </a>
      ...
      <section
        id="sobre"
        className="px-6 py-24 border-t border-gray-800"
      >
      ...
      >
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-3 max-w-6xl mx-auto">
          ...
          {/* SERVIÇO 1 */}
          <div className="rounded-2xl bg-gray-800 p-8 hover:-translate-y-1 transition">
      ...
      {/* FOOTER */}
      <footer className="border-t border-gray-800 bg-gray-950 px-6 py-8 text-center">
